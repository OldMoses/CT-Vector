...
'² º º                                                                            º º ²
'² º º Development and beta test version 0.51  uploaded __-__-2021                º º ²
'² º º                                                                            º º ²
...
'                                                               INITIAL PARAMETERS
VerA = 0: VerB = 5: VerC = 1 '                                  version tags
ttl = "CT Vector 0.51" '                                        Title bar string
...
SUB Remove_Units (mode AS _BYTE)
    ...
    IF units > 0 THEN
        ...
        Con_Blok 480, 225, 120, 32, "Yes [enter]", 0, &HFFC80000 ' clr&(4)
        Con_Blok 660, 225, 120, 32, "No [Esc]", 0, &HFFC80000 ' clr&(4)
        _DISPLAY
